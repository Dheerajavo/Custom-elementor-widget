...
class login_Widget extends \Elementor\Widget_Base
{
    ...
    {
        return __('Login Widget', 'elementor-custom-widget');
    }
    ...
    protected function _register_controls()
    {
        $this->start_controls_section(
            ...
            [
                'label' => __('Editing', 'elementor-custom-widget'),
            ]
        );
        $this->add_control(
			'log_image',
			[
				'label' => __('Login Image', 'elementor-custom-widget'),
        ...
        $this->add_control(
			'color',
			[
				'label' => esc_html__( 'Color of heading', 'elementor-custom-widget' ),
        ...
        $this->add_control(
            'text-color',
            [
                'label' => esc_html__( 'Button Text Color', 'elementor-custom-widget' ),
                'type' => \Elementor\Controls_Manager::COLOR,
        ...
        $this->add_control(
            'background-color',
            [
                'label' => esc_html__( 'Button Background Color', 'elementor-custom-widget' ),
                'type' => \Elementor\Controls_Manager::COLOR,
                'default' => '#2e7aff',
                'selectors' => [
